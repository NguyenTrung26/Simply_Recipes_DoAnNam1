        ...
        <main class="main">
            ...
            <section class="home section" id="home">
                <div class="home__container container grid">
                    <img src="assets/img/epi.webp" style="border-radius: 40px;" alt="home image" class="home__img">
                    ...
                    <div class="home__data">
                        <h1 class="home__title">
                            ...
                            <div>
                                <img style="border-radius: 20px;" src="assets/img/OIP.jpg" alt="home image">
                                Món ăn Việt 
                            </div>
                        </h1>

                        <p class="home__description">
                        Chế biến và thưởng thức với những món ăn ngon nhất khắp mọi miền trên Tổ quốc
                        </p>

                        <a href="menu.php" class="button">
                            Thử ngay <i class="ri-arrow-right-line"></i>
                        </a>
                    </div>
                </div>
                ...
                <div class="about__container container grid">
                    <div class="about__data">
                        ...
                        <h2 class="section__title about__title">
                            ...
                            những công thức đơn giản để làm nên những món ăn ngon
                        </h2>
                    </div>

                    <img src="assets/img/p1.jpg" style="border-radius: 40px;" alt="about image" class="about__img">
                </div>
            ...
            <section class="popular section" id="popular">
                ...
                <div class="popular__container container grid">
                    <article class="popular__card">
                        <img src="assets/img/miquang.jpg" style="border-radius: 60px;width: 170px;" alt="popular image" class="popular__img">

                        <h3 class="popular name">Mỳ quảng</h3>
                    ...
                    <article class="popular__card">
                        <img src="assets/img/pho.jpg" alt="popular image" style="border-radius: 60px;width: 170px; height: 155px;" class="popular__img">

                        <h3 class="popular name">Phở </h3>
                            <span class="popular__description">
                                Hà Nội
                            </span>
                    ...
                    <article class="popular__card">
                        <img src="assets/img/comtam.jpg" style="border-radius: 60px;width: 170px; height: 155px;" alt="popular image" class="popular__img">

                        <h3 class="popular name">Cơm tấm</h3>
                            <span class="popular__description">
                             Tp. Hồ Chí Minh
                            </span>
